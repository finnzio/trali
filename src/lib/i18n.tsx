...
const zhCN = {
  ...
  appAuthor: "作者",
  updateTitle: "应用更新",
  updateDescription: "检查 GitHub Releases 中是否有新版本。",
...
const zhTW: Messages = {
  ...
  appAuthor: "作者",
  updateTitle: "應用程式更新",
  updateDescription: "檢查 GitHub Releases 是否有新版本。",
...
const ja: Messages = {
  ...
  appAuthor: "作者",
  updateTitle: "アプリの更新",
  updateDescription: "GitHub Releases に新しいバージョンがあるか確認します。",
...
const ko: Messages = {
  ...
  appAuthor: "작성자",
  updateTitle: "앱 업데이트",
  updateDescription: "GitHub Releases에서 새 버전을 확인합니다.",
...
const es: Messages = {
  ...
  updateDescription: "Comprueba si hay una versión nueva en GitHub Releases.",
...
const de: Messages = {
  ...
  appAuthor: "Autor",
  updateTitle: "App-Updates",
  updateDescription: "Auf GitHub Releases nach einer neuen Version suchen.",
...
const fr: Messages = {
  ...
  updateDescription:
    "Rechercher une nouvelle version dans GitHub Releases.",
...
const ptBR: Messages = {
  ...
  updateDescription: "Verifique se há uma nova versão no GitHub Releases.",
...
const ru: Messages = {
  ...
  updateDescription: "Проверить новую версию в GitHub Releases.",
